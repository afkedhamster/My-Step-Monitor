...
功能：检查lcd繁忙状态
输入：无
输出：lcd_busy=1，忙，等待；0，闲，可写指令与数据
*/
void chk_busy(){
    //检查忙位
    digitalWrite(LCD_RS,0);
    digitlaWrite(LCD_RW,1);
...
void Init_LCD12864(void){
    ...
    delay(20);
    WriteCmd_LCD12864(0x01);//清楚显示，并设定地址指针位00H
    delay(20);
    WriteCmd_LCD12864(0x0c);//开显示，无游标不反白
    delay(20);
}
...
int main(int args, char *argv[]){
    ...
    WriteWord_LCD12864(0x80,"Hello lcd12846");
    if(argv[1]){
        WriteCmd_LCD12864(0x01);
